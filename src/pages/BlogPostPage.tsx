    ...
    <>
      ...
      <section className="sb-section">
        <div className="container" style={{ maxWidth: 860 }}>
          ...
          <h1 className="mt-3" style={{ fontWeight: 900 }}>{post.title}</h1>
          <div className="sb-muted">
            {post.category} · {post.readingMinutes} min read
          </div>

          <div className="sb-card p-3 mt-3">
            <img src="/images/placeholder-hero.png" alt="" className="img-fluid rounded-4" />
          </div>
          ...
          <div className="sb-card p-4 mt-4">
            ...
            <div className="d-flex gap-2 flex-wrap mt-3">
              <Link className="btn sb-btn-primary" to="/free">Get free template</Link>
