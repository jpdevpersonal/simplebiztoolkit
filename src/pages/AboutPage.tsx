        ...
        <div className="container" style={{ maxWidth: 900 }}>
          ...
          <div className="sb-card p-4">
            <p>
              ...
              your business operations and simplify your personal life.
            </p>
            <section className="p-3 h-100">
              <h2>Why Choose Us?</h2>
              <ul>
                <li>
                  <strong>Time-Saving Solutions:</strong> Our expertly designed
                  templates allow you to focus on what truly matters – your
                ...
                <li>
                  <strong>Original Designs:</strong> Every product in our store
                  is our original creation, ensuring you receive unique,
                  tailored solutions.
                </li>
                <li>
                  <strong>Versatility:</strong> From business invoices to
                  personal planners, we offer a wide range of templates to suit
                  your diverse needs.
                </li>
                <li>
